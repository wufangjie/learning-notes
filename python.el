...
;; Modified from emacs 24.5, higher version need more keystroke to create python process which I think is very inconvenient
;; 1. Delete variable highlight (too slow when a line, may be output, is long).
;; 2. Add some new python version's keyword, but their indent did not work right way, I may fix it, or not.
;; 3. Windows interpreter's encoding, utf-8
