...
(unless window-system
  ...
  (custom-set-faces
   ...
   '(font-lock-function-name-face ((t (:background "cyan" :underline t))) t)
   ...
   '(region ((t (:foreground "white" :background "cyan"))) t);white
   '(cursor ((t (:background "white"))) t)
   '(org-block ((t (:foreground "white"))) t)
   '(org-table ((t (:foreground "cyan"))) t)
   '(isearch ((t (:foreground "black" :background "yellow" :underline t))) t)
   '(isearch-fail ((t (:background "yellow" :bold t))) t)
   '(error ((t (:foreground "red" :bold t))) t)
   '(highlight ((t (:background "blue"))) t)
   '(lazy-highlight ((t (:foreground "white" :background "cyan"))) t)
   '(shadow ((t (:foreground "magenta"))) t)
   '(popup-face ((t (:foreground "black" :background "magenta"))) t)
   '(popup-summary-face ((t (:foreground "cyan" :background "magenta"))) t)
   '(popup-tip-face ((t (:foreground "white" :background "cyan"))) t)
   ...
   '(linum ((t (:foreground "red" :underline t))) t)
   '(ediff-even-diff-A ((t (:background "#red"))) t)
   '(ediff-even-diff-Ancestor ((t (:background "#red"))) t)
   '(ediff-even-diff-B ((t (:background "#red"))) t)
   '(ediff-even-diff-C ((t (:background "#red"))) t)
   '(ediff-odd-diff-A ((t (:background "#red"))) t)
   '(ediff-odd-diff-Ancestor ((t (:background "#red"))) t)
   '(ediff-odd-diff-B ((t (:background "#red"))) t)
   '(ediff-odd-diff-C ((t (:background "#red"))) t)
   '(ediff-current-diff-A ((t (:foreground "white" :background "cyan"))) t)
   '(ediff-current-diff-Ancestor ((t (:inherit ediff-current-diff-A))) t)
   '(ediff-current-diff-B ((t (:inherit ediff-current-diff-A))) t)
   '(ediff-current-diff-C ((t (:inherit ediff-current-diff-A))) t)
   '(ediff-fine-diff-A ((t (:foreground "black" :background "yellow"))) t)
   '(ediff-fine-diff-Ancestor ((t (:inherit ediff-fine-diff-A))) t)
   '(ediff-fine-diff-B ((t (:inherit ediff-fine-diff-A))) t)
   '(ediff-fine-diff-C ((t (:inherit ediff-fine-diff-A))) t)
   ))
...
(if window-system
  (custom-set-faces
   ...
   '(font-lock-function-name-face ((t (:background "#4682b4" :underline t))) t)
   ...
   '(region ((t (:background "#4682b4"))) t)
   '(cursor ((t (:background "#ffffff"))) t)
   '(org-block ((t (:foreground "#ffffff"))) t)
   '(org-table ((t (:foreground "#4682b4"))) t)
   '(isearch ((t (:foreground "#000000" :background "#ffa07a" :underline t))) t)
   '(isearch-fail ((t (:background "#ffa07a" :bold t))) t)
   '(error ((t (:foreground "#cd3333" :bold t))) t)
   '(highlight ((t (:background "#556b2f"))) t)
   '(lazy-highlight ((t (:foreground "#ffffff" :background "#4682b4"))) t)
   ...
   '(popup-tip-face ((t (:foreground "#ffffff" :background "#4682b4"))) t)
   '(popup-menu-selection-face ((t (:inherit popup-tip-face))) t)
   '(popup-selection-face ((t (:inherit popup-tip-face))) t)
