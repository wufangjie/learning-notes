...
;; 0. Make the comint work the way like 24.5, which I think is much convenient.
;; 1. Removed variable highlight (it is too slow when a line, may be the output, is very long), instead, highlighting the equal signs.
;; 2. Add some keywords and remove some keywords (pprint cls).
;; 3. Fix the encoding problem on Windows (Chinese).
;; 4. Pre import some useful packages (pprint ...)
;; 5. Remove prompts' text-read-only property
